...
export function Dashboard() {
	const updates = [
		{
			...
			avatar: "AK",
			time: "2h ago",
			text: "Completed ticket: Fix login bug in mobile app",
		...
		},
		{
			...
			avatar: "ML",
			time: "4h ago",
			text: "Completed task: Update chart labels on analytics dashboard",
		...
		},
		{
			...
			avatar: "JL",
			time: "6h ago",
			text: "Completed ticket: Resolve payment processing timeout",
	...
	return (
		<div className="p-8 space-y-6">
			<div>
				<h2 className="text-3xl text-gray-900 mb-1">Good morning, Sarah</h2>
						...
						>
							...
							<div className="flex-1 min-w-0">
								<div className="flex items-baseline gap-2 mb-1">
									<span className="text-sm text-gray-900">{update.user}</span>
									<span className="text-xs text-gray-400">{update.time}</span>
								</div>
								<p className="text-sm text-gray-500">{update.text}</p>
							</div>
						</div>
					))}
				</div>
			...
			<div className="bg-white rounded-2xl p-6 border border-gray-100">
				<h3 className="text-base text-gray-900 mb-1">Sprint Progress</h3>
				<p className="text-sm text-gray-500 mb-4">Week 2 of 2</p>
				...
				<p className="text-xs text-gray-500 mt-2">24 of 37 tasks completed</p>
			</div>
		</div>
	);
}
