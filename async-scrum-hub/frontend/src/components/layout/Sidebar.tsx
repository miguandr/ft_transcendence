import { LayoutDashboard, KanbanSquare, MessageSquare, AlertCircle, BarChart3, Activity } from "lucide-react";
...
const navItems = [
  ...
  { path: "/team-health", icon: Activity, label: "Team Health" },
];
    ...
    <aside className="w-64 border-r border-gray-100 bg-white h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="px-4 py-3 bg-gray-50 rounded-xl">
          <p className="text-xs text-gray-600">Team: Product Squad</p>
          <p className="text-xs text-gray-500 mt-1">5 members</p>
        </div>
      </div>
    </aside>
  );
